...
<Steps>
  1. **Reiniciar el escritorio virtual**: En Citrix, debes reiniciar el escritorio virtual como primera opción.
...
Si se encuentra una falla en el **proceso de migración** donde la validación es exitosa pero al intentar continuar en Greta no es posible, se deben seguir estos pasos:
