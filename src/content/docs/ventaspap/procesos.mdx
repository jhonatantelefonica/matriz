...
<Tabs>
   <TabItem label="Proceso">
    ...
    2. Ejecutar la siguiente Query:
       ```sql
       select numportabilidad "Numero movil", numcuenta "Código Cuenta", 'Inmediato' as "Modo Negocio" from vpap.vpap.tb_rpa_convergent_sales where cuentaportabilidad = false order by id;
       ```
    ...
    3. Copiar los registros en un Excel nuevo
       ...
       <br />
       Ejemplo: **ReordenamientoCuentas_21_05_2025_Web.xlsx**
       </Aside>
       <div class="flex justify-center w-full">
          <div class="w-3/4 border">
    ...
    5. Ingresar a la ruta: 
       ```js 
       \\wbogvmrpa04\RPA\LOAD_BOTS\P691_ReordenamientoCuentas\Insumo
       ```
